...
"""
    ...
    def process(self, query: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # 2. Busca vetorial com filtro opcional por ingestion_id/source_id
            filters = {}
            if ingestion_id:
            ...
            if not filters:
                self.logger.info("ℹ️ Busca vetorial SEM filtros (pesquisa aberta em todos os dados indexados)")

            self.logger.debug(f"Executando busca vetorial (threshold={similarity_threshold}, filters={filters or 'nenhum'})")
            
            # Executar busca (com ou sem filtros)
