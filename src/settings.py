...
# ========================================================================
# CONFIGURAÇÕES DE MEMÓRIA SEMÂNTICA (Long-term memory / recall)
# ========================================================================

# Quantidade de memórias a recuperar por consulta (recall) – padrão 5
SEMANTIC_MEMORY_RECALL_LIMIT: int = int(os.getenv("SEMANTIC_MEMORY_RECALL_LIMIT", "5"))

# Threshold mínimo de similaridade para considerar uma memória relevante (0.0–1.0)
# Padrão anterior era 0.6; configurable via .env se necessário
SEMANTIC_MEMORY_SIMILARITY_THRESHOLD: float = float(os.getenv("SEMANTIC_MEMORY_SIMILARITY_THRESHOLD", "0.6"))
